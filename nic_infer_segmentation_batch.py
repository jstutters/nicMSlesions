...
for scan in scan_list:
    ...
    print(
        "> INFO:", scan, "CNN Segmentation time: ", round(time.time() - seg_time), "sec"
    )
    ...
    print(
        "> INFO:", scan, "total pipeline time: ", round(time.time() - total_time), "sec"
    )
        ...
        try:
            copyfile(
                os.path.join(
                    current_folder,
                    options["experiment"],
                    options["experiment"] + "_out_CNN.nii.gz",
                ),
                os.path.join(
                    current_folder, "out_seg_" + options["experiment"] + ".nii.gz"
                ),
            )
